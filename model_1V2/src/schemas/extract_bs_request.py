"""
DTO para el handler extract BS (payload directo desde Step Function).
"""
...
class ExtractBsRequest:
    """Entrada ya normalizada para extraer Balance (BS) con IA."""
    ...
    def base_response_fields(self) -> Dict[str, Any]:
        """Campos que se repiten en casi todos los returns del handler."""
        return {
    ...
    @classmethod
    def from_direct_payload(cls, payload: Dict[str, Any]) -> "ExtractBsRequest":
        """
        Recibe el payload completo desde Step Function (sin envoltorio SQS).
        Extrae solo la key 'bs' de tables y years.
        """
