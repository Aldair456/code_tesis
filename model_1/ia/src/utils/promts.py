...
def promt_trimestral_year_pl(text):
    promt = (
        ...
        IMPORTANTE: Responde ÚNICAMENTE con el array JSON, sin explicaciones,
        sin razonamiento, sin texto antes ni después. No uses corchetes [ ]
        excepto para el JSON de salida. Tu respuesta debe empezar directamente
        con [ y terminar con ].

        Formato esperado:
        [{"year": 2025, "quarter": "Q1"}, {"year": 2024, "quarter": "Q4"}]
        """
